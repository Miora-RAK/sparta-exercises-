...
// of includes used on the array scientistsNumbers with the variable theComputedOne
...
if (isTheComputedOneInOurNumbers) {
  console.log(
    `The Answer to the Ultimate Question of Life, the Universe, and Everything is ${theComputedOne}, I knew it!`,
  );
} else {
